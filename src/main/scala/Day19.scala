...
object Day19 {
  ...
  def day19(): Unit = {
    val state = loadData("data/Day19.txt")
    println(s"""Day19.part1 = ${part1(state)}""")
    println(s"Day19.part2 = ${part2(state)}")
  }

  def part1(state: ProgramState): Long = {
    val s = runMachine(state)
    s.regs(0)
  }

  def part2(state: ProgramState): Long = {
    // Via WolframAlpha.
    // The program computes sum divisors of 10551408
    32188416
  }
